...
<div class="header bg-main">
  ...
  <div class="head-l"><a class="button button-little bg-green" href="{{url('/')}}" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;
...
<div class="leftnav">
    ...
    <h2><span class="icon-user"></span>幻灯片</h2>
    <ul>
        <li><a href="{{url('admin/image')}}" target="right"><span class="icon-caret-right"></span>轮播列表</a></li>
        <li><a href="{{url('admin/image/create')}}" target="right"><span class="icon-caret-right"></span>添加图片</a></li>
    </ul>
