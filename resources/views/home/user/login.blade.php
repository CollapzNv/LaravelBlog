                ...
                <div class="col-md-4 col-md-offset-4 floating-box">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="{{url('login')}}" accept-charset="UTF-8" class="userLogin">
                                {{csrf_field()}}
                                <div class="form-group ">
                                    <label class="control-label" for="username">用户名</label>
                                    <input class="form-control" name="username" type="text" value="" placeholder="请填写用户名" datatype="s2-10"/>
                                </div>
                                <div class="form-group ">
                                    <label class="control-label" for="password">密 码</label>
                                    <input class="form-control" name="password" type="password" value="" placeholder="请填写密码" datatype="s6-20"/>
                                </div>
                                <div class="form-group ">
